...
public class ConverterEmployee {
	...
	public static DetailsEmployee convertEmployeeToDetailsEmployee(Employee employee) {
		DetailsEmployee detailsEmployee = new DetailsEmployee(employee.getId())
				.username(employee.getUsername())
				.code(employee.getCode())
				.email(employee.getEmail())
				.theName(employee.getName())
				.atCity(employee.getCity())
				.withProfession(employee.getProfession())
				.atBranch(employee.getBranch())
				.build();
